...
export async function lookForAchievement(msg: Message, userID: string, userData: userAchievementDoc) {

	async function makeEmbed(index: number, userID: string, userAchievements: userAchievementDoc) {
