...
export default {
    ...
    async run(invokeParams) {
        const button = new ActionRowBuilder().addComponents(new ButtonBuilder()
            ...
            .setStyle("LINK"), new ButtonBuilder()
        ...
        const serverLink = new EmbedBuilder()
            ...
            .addFields({
            name: "Support Server",
            value: "This bot is devoloped as a part of a game studio - `InspaStorm`\nWe are mostly working on 2D games (it might change)",
        }, {
            name: "Invite Grim Bot",
            value: "Grim bot is a unique entertainment bot, Which gets regular updates\nFor any suggestions join the support server and lets us know",
        });
