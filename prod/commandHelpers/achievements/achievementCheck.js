...
export async function lookForAchievement(msg, userID, userData) {
    async function makeEmbed(index, userID, userAchievements) {
        ...
        if (typeof amountOfUnlockedAwards != "undefined") {
            ...
            amountOfUnlockedAwards = 1;
        const unlockedEmbed = new EmbedBuilder()
            .setColor("#00ffff")
            .setTitle("<:achievement:939468591395377213> Achivement Unlocked")
            .addFields(achievementList[index])
            .setFooter({
            text: `Found ${amountOfUnlockedAwards} out of ${Object.keys(achievementList).length} achievements`,
        });
