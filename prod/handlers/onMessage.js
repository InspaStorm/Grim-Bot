...
function lookingAchievements(msg, authorID) {
    try {
        const userData = global.locks.get('achievement').find(user => { return user.id == authorID; });
...
export async function handleMessage(msg) {
    ...
    if (msg.mentions.has(msg.client.user) && !msg.mentions.everyone && !msg.mentions.repliedUser)
